...
public class TankTest {
    ...
    public void shouldIncreaseLeftSpeed(){
        Tank tank = new Tank(new TankDriver(), new TankGun(5));
    ...
    @Test
    public void shouldStopLeft() {
        Tank tank = new Tank(new TankDriver(), new TankGun(5));

        tank.increaseLeftSpeed();
        tank.stopLeft();

        assertThat(tank.getLeftSpeed(), is(0));
    }

    @Test
    public void shouldStopRight() {
        Tank tank = new Tank(new TankDriver(), new TankGun(5));

        tank.increaseRightSpeed();
        tank.stopRight();

        assertThat(tank.getRightSpeed(), is(0));
    }
    ...
    public void shouldThrowExceptionFiringEmptyGun() throws OutOfShellsException {
        Tank tank = new Tank(new TankDriver(), new TankGun(0));
